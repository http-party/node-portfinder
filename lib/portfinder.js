...
// The reserved ports will be excluded in port selection
//
exports.reservedPorts = [];
...
exports.getPort = function (options, callback) {
  ...
  options.reserved = options.reserved || exports.reservedPorts;
  ...
  if (!!~options.reserved.indexOf(options.port)) {
    // Fake EADDRINUSE error
    return onError({code: 'EADDRINUSE'});
  }
